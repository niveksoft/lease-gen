...
- **Start Date:** ${COMMENCEMENT_DAY} ${COMMENCEMENT_MONTH} ${COMMENCEMENT_YEAR}
- **End Date:** ${TERMINATION_DAY} ${TERMINATION_MONTH} ${TERMINATION_YEAR}
- **Type:** Fixed term (does not automatically renew)
...
1. Submit written request with details (materials, contractors, timeline)
2. Landlord responds in writing within 14 days
3. If approved, Tenant gets required permits and uses licensed professionals
4. Tenant provides copies of permits and inspection certificates when done
...
**Special circumstances (no penalty):**  

- Domestic or family violence (with proper certification)
- Senior moving to supported living (with proper certification)
